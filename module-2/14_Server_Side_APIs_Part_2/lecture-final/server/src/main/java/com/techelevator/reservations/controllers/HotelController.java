...
public class HotelController {
    ...
    public List<Hotel> filterByStateAndCity(@RequestParam String state, @RequestParam(value="cityToSearch", required=false) String city, @RequestParam(required=false) String county) {
