<template>
    ...
    v-on:click.prevent="markReadUnread" v-if="book.read">Mark Unread</button>
    <button class="mark-read" 
    v-on:click.prevent="markReadUnread" v-if="!book.read">Mark Read</button>     
