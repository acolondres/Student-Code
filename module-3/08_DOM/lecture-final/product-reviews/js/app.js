...
const reviews = [
  ...
  {
    reviewer: 'Morbius',
    title: 'The book does not taste good',
    review:
      "I ate this book and regret it",
    rating: 3
  }
];
...
function displayReviews() {
  ...
  reviews.forEach( 
    (review) => {
      ...
      //Add the review to our main div
      main.insertAdjacentElement('beforeend', container); 

      // Add the h4 reviewer to our review container
      const reviewerTitle = document.createElement("h4");
      reviewerTitle.innerText = review.reviewer;
      container.appendChild(reviewerTitle);
 ...
 */
function addRating(container, numberOfStars) {
